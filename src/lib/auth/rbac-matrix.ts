...
export const RBAC_MATRIX: Record<string, MatrixEntry> = {
  ...
  '/api/admin/orders/[id]/status': { methods: { PATCH: BM } },
  ...
  '/api/admin/tax-invoices/[id]': { methods: { GET: BM, POST: BM } },
  '/api/admin/tax-invoices/[id]/retry': { methods: { POST: FIN } },
  '/api/admin/inventory/adjust-info': { methods: { GET: BM } },
  '/api/admin/stocktakes': { methods: { GET: BM, POST: BM } },
  '/api/admin/stocktakes/[id]': { methods: { GET: BM } },
  '/api/admin/stocktakes/[id]/lines': { methods: { PATCH: BM } },
  '/api/admin/stocktakes/[id]/approve': { methods: { POST: BM } },
  '/api/admin/stocktakes/[id]/report': { methods: { GET: ['SUPER_ADMIN', 'BRANCH_MANAGER', 'FINANCE'] } },
